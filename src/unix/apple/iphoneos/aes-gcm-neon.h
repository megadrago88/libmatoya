...
#define _mm_slli_epi32(a, imm) \
	((imm) <= 0) ? (a) : (imm) > 31 ? _mm_setzero_si128() : vreinterpretq_s64_s32(vshlq_s32(vreinterpretq_s32_s64(a), vdupq_n_s32(imm)))
...
#define _mm_shuffle_epi8(a, b) \
	vreinterpretq_s64_s8(vqtbl1q_s8(vreinterpretq_s8_s64(a), vandq_u8(vreinterpretq_u8_s64(b), vdupq_n_u8(0x8F))))

#define _mm_aesenc_si128(a, b) \
	vreinterpretq_s64_u8(vaesmcq_u8(vaeseq_u8(vreinterpretq_u8_s64(a), vdupq_n_u8(0))) ^ vreinterpretq_u8_s64(b))

#define _mm_aesenclast_si128(a, RoundKey) \
	_mm_xor_si128(vreinterpretq_s64_u8(vaeseq_u8(vreinterpretq_u8_s64(a), vdupq_n_u8(0))), RoundKey)

#define _vmull_p64(a, b) \
	vreinterpretq_u64_p128(vmull_p64(vget_lane_p64(vreinterpret_p64_u64(a), 0), vget_lane_p64(vreinterpret_p64_u64(b), 0)))
...
static __m128i _mm_set_epi8(int8_t b15, int8_t b14, int8_t b13, int8_t b12,
	int8_t b11, int8_t b10, int8_t b9, int8_t b8, int8_t b7, int8_t b6,
	int8_t b5, int8_t b4, int8_t b3, int8_t b2, int8_t b1, int8_t b0)
{
