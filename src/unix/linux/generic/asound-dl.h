...
static bool asound_dl_global_init(void)
{
	...
	if (!ASOUND_DL_INIT) {
		...
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params_any);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params_set_access);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params_set_format);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params_set_channels);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params_set_rate);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_hw_params);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_prepare);
		LOAD_SYM(ASOUND_DL_SO, snd_pcm_writei);
