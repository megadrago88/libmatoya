...
struct gfx_d3d11_ui {
	struct gfx_d3d11_ui_buffer vb;
	struct gfx_d3d11_ui_buffer ib;
...
struct gfx_ui *gfx_d3d11_ui_create(MTY_Device *device)
{
	...
	desc.ByteWidth = sizeof(struct gfx_d3d11_ui_cb);
	...
	if (e != S_OK)
		gfx_d3d11_ui_destroy((struct gfx_ui **) &ctx);

	return (struct gfx_ui *) ctx;
}

static HRESULT gfx_d3d11_ui_resize_buffer(ID3D11Device *device, struct gfx_d3d11_ui_buffer *buf,
...
bool gfx_d3d11_ui_render(struct gfx_ui *gfx_ui, MTY_Device *device, MTY_Context *context,
	const MTY_DrawData *dd, MTY_Hash *cache, MTY_Texture *dest)
{
	struct gfx_d3d11_ui *ctx = (struct gfx_d3d11_ui *) gfx_ui;
	ID3D11Device *_device = (ID3D11Device *) device;
	...
	struct gfx_d3d11_ui_cb *cb = (struct gfx_d3d11_ui_cb *) cb_map.pData;
...
void *gfx_d3d11_ui_create_texture(MTY_Device *device, const void *rgba, uint32_t width, uint32_t height)
{
	ID3D11Device *_device = (ID3D11Device *) device;
...
void gfx_d3d11_ui_destroy_texture(void **texture)
{
	if (!texture || !*texture)
		return;
...
void gfx_d3d11_ui_destroy(struct gfx_ui **gfx_ui)
{
	if (!gfx_ui || !*gfx_ui)
		return;
